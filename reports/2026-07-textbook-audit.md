...
| H14 | ⬜ pending | — | Finish the quick-reference appendices |
| H15 | ⬜ pending | — | Populate or drop the empty back-matter apparatus |
| H16 | ⬜ pending | — | Add alt-text/descriptions to all images and interactives |
| H17 | ⬜ pending | — | Complete reading checkpoints in uncovered sections |
| M1 | ⬜ pending | — | Sweep build-integrity defects (Rec 4) |
| M2 | ⬜ pending | — | Prune orphaned assets and generated artifacts (Rec 7) |
...
**High:** 13/17 done &nbsp;·&nbsp; **Medium:** 0/10 done &nbsp;·&nbsp; **Low:** 1/6 done &nbsp;·&nbsp; **Overall:** 14/33.
