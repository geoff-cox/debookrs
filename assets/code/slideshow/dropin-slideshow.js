...
// Slide definitions
const slides = [ /* same as your current slides array */ ];
...
function drawButtons() {
    ...
    // Back button
    ctx.fillStyle = currentSlide === 0 ? "#ccc" : (hoverBack ? "#388e3c" : "#4CAF50");
    ...
    // Next button
    ctx.fillStyle = currentSlide === slides.length - 1 ? "#ccc" : (hoverNext ? "#388e3c" : "#4CAF50");
