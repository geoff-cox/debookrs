...
},
{
  ...
  "number": "26",
  "title": "Solve the initial-value problem.",
  "body": "Solve the initial-value problem     Step 1: Apply the Forward Transform   Step 1 . Applying to both sides of , we have where and  ,  .  So the complete forward transform of is    Step 2a: Solve for   Step 2a . Next, we isolate on one side of the equation:    Step 2b: Prepare for the Backward Transform   Step 2b . Now, we need to express as a sum of functions that match known forms in the Laplace transform table, which requires partial fraction decomposition. We start by writing down the form of the decomposition, Now, we find and by plugging in values of ,        :                   :                   :                         So the updated is . Note, the second term is not yet ready and we need to complete the square of its denominator before we can do the backward step.    Step 3: Apply the Backward Transform   Step 3 . Now for the backward step to get the solution:    "
},
{
  "id": "p4-c3-s2-1-rq1",
  "level": "2",
