...
},
{
  ...
  "number": "16",
  "title": "",
  "body": " Find the form of for each of the equations below.      Solution Since has the form , we set .           Solution  has the form , so .           Solution  has the form , so .           Solution Since is of the form , we set .           Solution Even though only has an term, we consider it to be of the form , where . Therefore, .     "
},
{
  "id": "main-7-4-5-8",
  "level": "2",
  ...
  "number": "17",
  "title": "",
  "body": " Given each of the constant terms, , of an LNCC equation below, find the form of you would use.      Solution Since is the sum of an term and a constant term, we set .           Solution Since is the sum of an term and a term, we set .           Solution Since is the sum of a term and a term, we set .     "
},
{
  "id": "main-7-4-5-10",
  "level": "2",
  ...
  "number": "18",
  "title": "",
  "body": " Find the form of for the equation .  Solution  Since is the product of a polynomial and an exponential, we initially set: . However, is redundant because if we multiply it onto the polynomial, it can be absorbed into and , as follows: . So, the form of simplifies to: .   "
},
{
  "id": "main-7-4-5-14",
  "level": "2",
...
},
{
  ...
  "number": "22",
  "title": "",
  "body": " Find the general solution to each LNCC equation using the method of undetermined coefficients. . Solution  Following the method of , we first find as . Next, we select the initial form of as and adjust , if necessary. A quick check shows that has no terms in common with .  Finally, we find the coefficients of . To do this, let's compute , , plug these into the equation, and collect the , , and constant terms as follows:  . Matching the underlined coefficients leads to the following system of equations and solution for the coefficients , , and :                The general solution is then .     . Solution  Following the method of , we find as and then find through the steps that follow.   . The initial form of is ,   . Notice that has an term, which overlaps with . Therefore, we need to adjust by multiplying the term by , . Now that and are independent, we can proceed to find the coefficients , , and .   . Before plugging in , let's find and : . Now, substituting these into the equation and collecting like terms, to get , which leads to the following equations for , , and :                Finally, the general solution is .    "
},
{
  "id": "p3-c2-s5-rq3",
  "level": "2",
